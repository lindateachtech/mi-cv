...
tribble(
  ~ study, ~ university, ~ loc, ~ dates, ~ details,
  "Ingeniera en Auditoría", "Escuela Superior Politécnica del Litoral", "Guayaquil, EC", "2014", "Métodos cuantitativos, Matemáticas financieras, Estadística inferencial, Muestreo y diseño de cuestionarios, Base de datos para auditores, Análisis multivariado y muestreo, Ingeniería de calidad, Auditoría operacional, Auditoría de sistemas informáticos, entre otras 34 asignaturas más.",
...
tribble(
  ~ study, ~ university, ~ loc, ~ dates, ~ details,
    "Sociedad Ecuatoriana de Estadística", "Instructora de Software (virtual)","Quito, EC", "04, 2022 - presente", "Módulo Softwares para el manejo de datos del Programa Internacional de Estadística aplicada a la Investigación Científica. (2 ediciones)",
    "Sociedad Ecuatoriana de Estadística", "Instructora de Software (virtual)","Quito, EC", "04, 2022 - presente", "Curso Manejo de Datos con R de cero a ninja. (3 ediciones)",
    "Sociedad Ecuatoriana de Estadística", "Instructora de Software (virtual)","Quito, EC", "04, 2022 - presente", "Curso Análisis de Datos con R y ShinyApps. (3 ediciones)",
) |> 
  detailed_entries(study, dates, university, loc, details, .protect=FALSE)
```
...
tribble(
  ~ study, ~ university, ~ loc, ~ dates, ~ details,
    "Corporación Eléctrica del Ecuador CELEC", "Directora Administrativa","Machala, EC", "04, 2019 - 09, 2022", "Impartí las cátedras de Matemática I y II para la Carrera de Economía y Contaduría Pública Autorizada, enfocándome en conceptos fundamentales y su aplicación práctica en el ámbito financiero y económico.",
     "Universidad Metropolitana (Sede Machala)", "Profesora universitaria a medio tiempo","Machala, EC", "04, 2019 - 09, 2022", "Participé activamente en la mejora del plan de estudios, contribuyendo a la actualización de contenidos para alinearlos con las demandas del mercado laboral.",
) |> 
  detailed_entries(study, dates, university, loc, details, .protect=FALSE)
```
